...
namespace Xyglo.Unity
{
    ...
    public class SquishMote : Mote
    {
        ...
        public SquishMote(float weight)
        ...
        public SquishMote(GameObject gameObject, bool startOffScreen, Texture originalTexture, Texture alarmedTexture, Vector2 textureSize, float aggressiveness = 0.1f)
            : base(gameObject)
        {
            m_worth = 250;
        ...
        public SquishMote(Vector3 position)
            : base(position)
        {
            m_worth = 250;
        }
