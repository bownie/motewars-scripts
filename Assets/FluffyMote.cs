...
{
    public class FluffyMote : Mote
    {
        /// <summary>
        /// Default worth 50 and start off screen
        /// </summary>
        public FluffyMote(float weight):base(weight, 50, true)
        {
        }

        public FluffyMote(GameObject gameObject, bool startOffScreen, Vector2 textureSize, float aggressiveness = 0.1f)
            : base(gameObject)
        {
            m_worth = 50;
        ...
        public FluffyMote(Vector3 position)
            : base(position)
        {
            m_worth = 50;
        }
        ...
        public FluffyMote(float weight, int worth, bool offScreen):base(weight, worth, offScreen)
        {
        }
