...
{
    public class GenericMote : Mote
    {
        /// <summary>
        /// Default worth 50 and start off screen
        /// </summary>
        public GenericMote(float weight):base(weight, 50, true)
        {
        }

        public GenericMote(GameObject gameObject, bool startOffScreen, Vector2 textureSize, float aggressiveness = 0.1f)
            : base(gameObject)
        {
            m_worth = 50;
        ...
        public GenericMote(Vector3 position)
            : base(position)
        {
            m_worth = 50;
        }
        ...
        public GenericMote(float weight, int worth, bool offScreen):base(weight, worth, offScreen)
        {
        }
